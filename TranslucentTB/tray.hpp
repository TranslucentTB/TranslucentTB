...
namespace Tray {
	...
	static const std::unordered_map<ACCENT, uint32_t> NORMAL_BUTTON_MAP = {
		{ ACCENT::ACCENT_NORMAL,						IDM_NORMAL },
		{ ACCENT::ACCENT_ENABLE_TRANSPARENTGRADIENT,	IDM_CLEAR  },
		{ ACCENT::ACCENT_ENABLE_GRADIENT,				IDM_OPAQUE },
		{ ACCENT::ACCENT_ENABLE_BLURBEHIND,				IDM_BLUR   },
		{ ACCENT::ACCENT_ENABLE_FLUENT,					IDM_FLUENT }
	};
	static const std::unordered_map<ACCENT, uint32_t> DYNAMIC_BUTTON_MAP = {
		{ ACCENT::ACCENT_NORMAL,						IDM_DYNAMICWS_NORMAL },
		{ ACCENT::ACCENT_ENABLE_TRANSPARENTGRADIENT,	IDM_DYNAMICWS_CLEAR  },
		{ ACCENT::ACCENT_ENABLE_GRADIENT,				IDM_DYNAMICWS_OPAQUE },
		{ ACCENT::ACCENT_ENABLE_BLURBEHIND,				IDM_DYNAMICWS_BLUR   },
		{ ACCENT::ACCENT_ENABLE_FLUENT,					IDM_DYNAMICWS_FLUENT }
	};
