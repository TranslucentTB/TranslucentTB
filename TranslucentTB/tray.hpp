...
static const std::unordered_map<Taskbar::AEROPEEKSTATE, uint32_t> PEEK_BUTTON_MAP = {
	{ Taskbar::Disabled,	IDM_NOPEEK },
	{ Taskbar::Dynamic,		IDM_DPEEK },
	{ Taskbar::Enabled,		IDM_PEEK }
};
