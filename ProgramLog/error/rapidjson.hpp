...
#define ParseErrorCodeHandle(code_, level_, message_) Error::impl::Handle<(level_)>(Util::ToStringView((message_)), rapidjson::GetParseError_En((code_)), PROGRAMLOG_ERROR_LOCATION)
